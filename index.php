...
<html lang="en">
  <head>
    ...
    <link rel="icon" href="img/favicon.png">
     ...
     <title>My AnonymousChat.com</title>
...
<main>
  ...
  <div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light">
    <div class="col-md-5 p-lg-5 mx-auto my-5">
      <h1 class="display-4 fw-normal">My AnonymousChat</h1>
      <p class="lead fw-normal">Chat with anyone feel free to express your feelings in the form of happiness</p>
